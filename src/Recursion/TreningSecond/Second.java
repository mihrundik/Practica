...
public class Second {
    ...
    public void fifteenth(int count_0, int count_1, int x) {
        ...
        if (x < 2) {
            ...
            } else if (x == 0 && count_0 > 2) {
                count_0++;
            }
            fifteenth(count_0, count_1, x);
        } else {
    ...
    public void sixteenth(int print, int x) {
        if (print >= x / 2) {
            return;
        }

        for(int i = print; i <= print + 1; i++) {
